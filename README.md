...
| [talktome-chat](talktome-chat/) | 对外**问** | 用户有个“得问个懂行的人”的需求时，去平台上语义检索对口的分身（真人的对外代理），用户确认后替他聊到目的达成（10 轮硬上限），把结论带回来并留档、下次能接着聊 | “想找人聊聊融资”“帮我问问这家公司的面试流程”“找个做供应链的人请教一下”“上次跟那个分身聊了什么” |
